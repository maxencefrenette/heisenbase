...
- Pawn locations are written explicitly after the piece tokens using lowercase algebraic squares (`a2`, `h7`, ...). Their order is determined by ascending `Square::to_u32()` so string representations remain stable.
